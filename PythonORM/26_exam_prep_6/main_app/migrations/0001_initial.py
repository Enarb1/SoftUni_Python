# Generated by Django 5.0.4 on 2025-03-24 09:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wins', models.PositiveSmallIntegerField(default=0)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('power', models.DecimalField(decimal_places=1, default=1.0, max_digits=3, validators=[main_app.validators.RangeValidator(1.0, 10.0, message='The value must be between 1.0 and 10.0')])),
