# Generated by Django 5.0.4 on 2025-03-25 15:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(decimal_places=1, default=0.0, max_digits=3, validators=[main_app.validators.RangeValidator(0.0, 10.0, message='The number must be between 0.0 and 10.0')])),
