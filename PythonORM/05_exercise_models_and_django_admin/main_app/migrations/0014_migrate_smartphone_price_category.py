# Generated by Django 5.0.4 on 2025-02-11 15:07
...
def set_category(apps, schema_editor):
    ...
    for smartphone in smartphones:
        if smartphone.price >= EXPENSIVE_PRICE:
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(set_all_columns, reverse_code=reverse_price_and_category),
    ]
