# Generated by Django 5.0.4 on 2025-03-28 10:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ranking', models.PositiveIntegerField(validators=[main_app.validators.RangeValidator(1, 300, message='Choose a number between 1 and 300')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('winner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='winners', to='main_app.tennisplayer')),
